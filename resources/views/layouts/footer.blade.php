...
<script src="{{ public_asset('assets/frontend/lib/easing/easing.min.js') }}"></script>
<script src="{{ public_asset('assets/frontend/lib/owlcarousel/owl.carousel.min.js') }}"></script>
<script src="{{ public_asset('assets/frontend/lib/tempusdominus/js/moment.min.js') }}"></script>
<script src="{{ public_asset('assets/frontend/lib/tempusdominus/js/moment-timezone.min.js') }}"></script>
<script src="{{ public_asset('assets/frontend/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js') }}"></script>

<!-- Contact Javascript File -->
<script src="{{ public_asset('assets/frontend/mail/jqBootstrapValidation.min.js') }}"></script>
<script src="{{ public_asset('assets/frontend/mail/contact.js') }}"></script>

<!-- Template Javascript -->
<script src="{{ public_asset('assets/frontend/js/main.js') }}"></script>
